...
#     print("\n\nMeasurement Values")
#     measurement_lst = list(runner.app.db.subject_objects(URIRef("http://semanticscience.org/resource/hasValue")))
#     # for source, measurement in measurement_lst:
#         # print(source.n3(), measurement.n3())
#     runner.assertEqual(len(measurement_lst), 10)
