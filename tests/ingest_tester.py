...
def autoparse(file_under_test):
    ...
    expected_data["authors"]    = [elem.text for elem in common_fields.iter("Author")]
    expected_data["keywords"]   = [elem.text.title() for elem in common_fields.iter("Keyword")]
    expected_data["DOI"]        = [elem.text.title() for elem in common_fields.iter("DOI")]
